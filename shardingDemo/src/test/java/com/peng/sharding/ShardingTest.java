package com.peng.sharding;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.conditions.update.UpdateWrapper;
import com.peng.sharding.entity.Course;
import com.peng.sharding.mapper.CourseMapper;
...
//    @Transactional
    ...
    public void queryCourse() {
        ...
        wrapper.eq("cid",1019296154908622848L);
//        wrapper.in("cid",1019296154908622848L,1019296156095610880L,1019296157005774848L,5L);
        //带上排序条件不影响分片逻辑
//        wrapper.orderByDesc("user_id");
    ...
    public void queryCourseRange(){
        ...
        wrapper.between("cid",1019296154908622848L,1019296157005774848L);
        List<Course> courses = courseMapper.selectList(wrapper);
        courses.forEach(course -> System.out.println(course));
    }
    ...
    public void queryCourseComplexSimple(){
        QueryWrapper<Course> wrapper = new QueryWrapper<Course>();
//        wrapper.orderByDesc("user_id");
        wrapper.in("cid",1019296154908622848L,1019296157005774848L);
        wrapper.eq("user_id",1002L);
    ...
    public void queryCourdeComplex(){
        QueryWrapper<Course> wrapper = new QueryWrapper<Course>();
        wrapper.in("cid",1019296154908622848L,1019296157005774848L,5L);
